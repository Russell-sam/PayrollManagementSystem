...
Public Class jobGroup
    ...
    Private Sub jobGroup_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        cm = New MySqlCommand("insert into monthly_entries values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "')", MySqlConnection)
        cm.ExecuteNonQuery()
